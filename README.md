...
detection, image recognition, etc. The focused
[`06_AGENT_HARNESS`](./06_AGENT_HARNESS) exercise builds a small coding-agent
interface with LangChain Deep Agents and Streamlit.
...
The focused [`07_CI_CD`](./07_CI_CD) exercise tests, containerizes, and deploys
an LLM-backed API to development and production Cloud Run services.
